  ...
  return (
    <div className="navbar bg-base-100/80 backdrop-blur-lg shadow-xl sticky top-0 z-50 border-b border-base-300">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 gap-1">
          <li>
            <Link
              href="/random"
              className={`${pathname === "/random" ? "active bg-primary text-primary-content" : ""} hover:scale-105 transition-transform`}
            >
              🎲 Aleatória
            </Link>
          </li>
          <li>
            <Link
              href="/buscar"
              className={`${pathname === "/buscar" ? "active bg-primary text-primary-content" : ""} hover:scale-105 transition-transform`}
            >
              🔍 Buscar
            </Link>
          </li>
          <li>
            <Link
              href="/favoritos"
              className={`${pathname === "/favoritos" ? "active bg-primary text-primary-content" : ""} hover:scale-105 transition-transform`}
            >
              ⭐ Favoritos
            </Link>
          </li>
          <li>
            <Link
              href="/criar"
              className={`${pathname === "/criar" ? "active bg-primary text-primary-content" : ""} hover:scale-105 transition-transform`}
            >
              ➕ Criar
            </Link>
          </li>
      ...
      <div className="navbar-end gap-2">
        ...
        {loading ? (
          <div className="btn btn-ghost btn-sm loading"></div>
        ) : user ? (
          <div className="dropdown dropdown-end">
            <label tabIndex={0} className="btn btn-ghost gap-2 cursor-pointer">
              ...
              <span className="hidden md:inline max-w-[150px] truncate pointer-events-none select-none">
                {user.email}
              </span>
          ...
          <Link href="/auth/login" className="btn btn-primary gap-2 shadow-lg hover:scale-105 transition-transform">
